...
int main() {
    ...
    cout << "Eq1 (interpreted as): " << arr[0][0] << "X + " << arr[0][1] << "Y + " << arr[0][2] << "Z + " << arr[0][3] << " = 0 ";
    
    cout << "\n\nEquation 2:-\n";
    cin >> arr[1][0] >> arr[1][1] >> arr[1][2] >> arr[1][3];
    cout << "Eq2 (interpreted as): " << arr[1][0] << "X + " << arr[1][1] << "Y + " << arr[1][2] << "Z + " << arr[1][3] << " = 0 ";
    
    cout << "\n\nEquation 3:-\n";
    cin >> arr[2][0] >> arr[2][1] >> arr[2][2] >> arr[2][3];
    cout << "Eq3 (interpreted as): " << arr[2][0] << "X + " << arr[2][1] << "Y + " << arr[2][2] << "Z + " << arr[2][3] << " = 0 ";
